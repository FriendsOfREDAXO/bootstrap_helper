<?php
use krol\rex_modul_backend_output;
use krol\Cards;
use krol\bsCard;
...
$bbb = new rex_modul_backend_output();
$bbb->out('title','text');
echo  $bbb;


 $card = new bsCard;
 $card->addTitle = "erwrwer";
 $card->addContent( 'card werwerewr' );
 $card->showCard();
 ...
 $card = new bsCard;
 $card->addTitle = "Accordion Title";
 $card->addContent( 'Accordion Content' );
 $card->showAccordion();
...
****/
      ...
      if ($value['ueberschrift']  != '') {
        ...
        $outback .= '
          <h3>Überschrift</h3>';
/*
          $ueberschrift1 = new rex_modul_backend_output();
          $ueberschrift1->outback('Überschrift',$value['ueberschrift']);

          $ueberschrift2 = new rex_modul_backend_output();
          $ueberschrift2->outback('Art der Überschrift',$art);

          $outback .= $ueberschrift1;
          $outback .= $ueberschrift2;
*/
